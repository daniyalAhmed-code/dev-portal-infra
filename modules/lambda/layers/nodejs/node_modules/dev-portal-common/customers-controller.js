...
let getLoggedInUserDetails = async(username) =>{
  let logged_in_user_details = {}
  let params = {
    UserName : username
  }
  try{
  logged_in_user_details = await iam.getUser(params).promise()
...
return {
          "Username": logged_in_user_details.User.UserName,
          "UserId": logged_in_user_details.User.UserId,
          "Arn": logged_in_user_details.User.Arn,
}
}
