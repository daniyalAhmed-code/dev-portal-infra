...
exports.getCognitoIdentityId = req => {
  return req.requestContext.authorizer.cognitoIdentityId
}

exports.getCognitoIdentitySub = req => {
  const provider = req.requestContext.authorizer.UserId
...
exports.getCognitoUserId = req => {
  const userPoolUserId = req.requestContext.authorizer.Usersub
