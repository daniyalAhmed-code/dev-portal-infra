...
output "LAMBDA_SIGNIN_INVOKE_ARN" {
  value = aws_lambda_function.lambda_sigin_function.invoke_arn
}
output "SIGNIN_LAMBDA_NAME" {
  value = aws_lambda_function.lambda_sigin_function.function_name
}
...
output "LAMBDA_GET_CATALOG_INVOKE_ARN"{
  value = aws_lambda_function.lambda_catalog_function.invoke_arn
}
output "GET_CATALOG_LAMBDA_NAME"{
  value = aws_lambda_function.lambda_catalog_function.function_name
}
