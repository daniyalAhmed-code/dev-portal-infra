...
class GetAllCatalog extends BaseHandler {
    constructor() {
        super();
    }
...
exports.getAllCatalog = async(event, context, callback) => {
    return await new GetAllCatalog().handler(event, context, callback);
};
