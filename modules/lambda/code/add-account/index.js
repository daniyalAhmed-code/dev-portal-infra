...
class AddAccounts extends BaseHandler {
    constructor() {
        super();
    }
    async process(event, context, callback) {
      ...
      let body = await schema.validate(event.body);
...
exports.addAccounts = async(event, context, callback) => {
    return await new AddAccounts().handler(event, context, callback);
};