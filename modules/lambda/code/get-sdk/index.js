...
class GetSDK extends BaseHandler {
    constructor() {
        super();
    }
    async process(event, context, callback) {
        console.log(`GET /catalog/${req.params.id}/sdk for Cognito ID: ${util.getCognitoIdentityId(event)}`)
...
exports.getSDK = async(event, context, callback) => {
    return await new GetSDK().handler(event, context, callback);
};