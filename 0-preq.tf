locals {
  ...
  CUSTOMER_REQUEST_LOGS_TABLE_NAME  = data.terraform_remote_state.vap-platform-infra.outputs.CUSTOMER_REQUEST_LOGS_TABLE_NAME
  ...
  CUSTOMER_REQUEST_LOGS_TABLE_ARN = data.terraform_remote_state.vap-platform-infra.outputs.CUSTOMER_REQUEST_LOGS_TABLE_ARN
